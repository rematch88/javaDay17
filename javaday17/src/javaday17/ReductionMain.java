...
public class ReductionMain {
	...
	public static void main(String[] args) {
		...
		//String은 크기비교가 가능하기 때문에 바로 오름차순 정렬
		arStream = Arrays.stream(ar);
		arStream.sorted().forEach(System.out::println);
		
		System.out.println();
		stream = list.stream();
		//Student는 여러 개의 항묵을 소유하고 있기 때문에 어떤 항목으로 크기를 비교할지 알지 못하기 때문에 예외가 발생
